class Move():
    def __init__(self, hland, player1, player2):
        ...
        self.player1Move = player1.findBestMove(self.player2)
        self.player2Move = player2.findBestMove(self.player1)
        self.player1Score, self.player2Score = hland.getPayout(self.player1Move, self.player2Move)
        self.player1.addMoveToHistory(self)
        self.player2.addMoveToHistory(self)
